...
import busters
import game
from test.test_mmap import LargeMmapTests
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for p in self.legalPositions:
            ...
            for pos in newPosDist:
                allPossible[pos] += self.beliefs[p] * newPosDist[pos];
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        # if there are more particles than legal positions,
        # wrap around 
    ...
    def observe(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            allPossible[particle] += emissionModel[dist];
        ...
        if allPossible.totalCount() == 0:
            ...
            for _ in range(self.numParticles):
                updatedParticles.append(util.sample(allPossible));
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        self.particles = [];
        itTools = itertools.product(self.legalPositions, repeat = self.numGhosts);
        perms = list(itTools);
        ...
        for p in self.particles:
            ...
            for i in range(self.numGhosts):
                if noisyDistances[i] == None:
                    ...
                    weight *= emissionModels[i][trueDist];
